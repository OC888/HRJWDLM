...
#define cellHeight ([[UIScreen mainScreen] bounds].size.height-64)/3
...
//    [self.imgView sd_setImageWithURL:[NSURL URLWithString:_model.] placeholderImage:nil];
    [self.imgView setImage:[UIImage imageNamed:@"1153.jpeg"]];
    
     self.titleLabel.text = _model.uploaddatetime;
}
