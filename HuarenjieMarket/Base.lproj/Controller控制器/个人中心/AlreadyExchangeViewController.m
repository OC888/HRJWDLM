//
//  AlreadyExchangeViewController.m
//  HuarenjieMarket
//
...
@interface AlreadyExchangeViewController ()

@end

@implementation AlreadyExchangeViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        cell.textLabel.text = @"兑换日期：2011-03-31 10：32：43";
    // Configure the cell...
