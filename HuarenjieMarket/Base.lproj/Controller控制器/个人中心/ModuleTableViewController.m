...
//    店铺开店
    if (indexPath.row == 0) {
//        _baseAlert1 = nil;
//        _baseAlert1 = [[UIAlertView alloc]initWithTitle:@"店铺" message:@"对不起，您暂无店铺" delegate:self cancelButtonTitle:nil otherButtonTitles: nil];
//        [NSTimer scheduledTimerWithTimeInterval:1.0f target:self selector: @selector(performDismiss1:) userInfo:nil repeats:NO];
//        [_baseAlert1 show];
//        SetOfShopViewController *setshopVC = [[SetOfShopViewController alloc]initWithNibName:@"SetOfShopViewController" bundle:nil];
        SetOfShopViewController *setshopVC = [[SetOfShopViewController alloc]init];
...
//    订单
    if (indexPath.row == 3) {
        _baseAlert = nil;
        _baseAlert = [[UIAlertView alloc]initWithTitle:@"订单" message:@"对不起，您暂无订单" delegate:self cancelButtonTitle:nil otherButtonTitles:nil];
