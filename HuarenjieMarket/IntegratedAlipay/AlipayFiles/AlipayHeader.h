 ...
 */
#define kPartnerID @"2088021966077109"

/**
*  seller:支付宝收款账号,手机号码或邮箱格式。
*/
#define kSellerAccount @"huarenjie88@163.com"

/**
 *  支付宝服务器主动通知商户 网站里指定的页面 http 路径。
 */
#define kNotifyURL @"http://zghrj.cn/alipay-sdk/notify_ios_url.php"

/**
 *  appSckeme:应用注册scheme,在Info.plist定义URLtypes，处理支付宝回调
 */
#define kAppScheme @"SSalipay"

/*
   private_key:商户方的私钥,pkcs8 格式。
*/
#define kPrivateKey @""
